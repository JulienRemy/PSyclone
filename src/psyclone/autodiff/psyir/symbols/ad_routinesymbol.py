...
class ADRoutineSymbol(RoutineSymbol, ADPSyIR):
    ...
    def __init__(self, name, datatype = None, motion = ADMotion.ADVANCING, **kwargs):
        ...
        if motion is ADMotion.ADVANCING:
            ...
            self._recording_routine_symbol = self.create_recording_routine_symbol()
            self._returning_routine_symbol = self.create_returning_routine_symbol()
            self._reversing_routine_symbol = self.create_reversing_routine_symbol()
    ...
    def from_psyir(cls, routine_symbol):
        ...
        if routine_symbol in cls._psyir_to_ad:
            ...
            ad_routine_symbol = cls(name = routine_symbol.name,
